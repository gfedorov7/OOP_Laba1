...
public sealed class HousingDepartmentTests
{
    ...
    {
        housingDepartment = new HousingDepartment();
    ...
    public void OneParamConstructorTest()
    {
        ...
        housingDepartment = new HousingDepartment(district);
    ...
    public void TwoParamsConstructorTest()
    {
        ...
        housingDepartment = new HousingDepartment(district, housingDepartmentNumber);
    ...
    public void AllParamsConstructorTest()
    {
        ...
        housingDepartment = new HousingDepartment(district, housingDepartmentNumber, residents, paidResidentsCount, 
            tariff, balance, employeeCount);
